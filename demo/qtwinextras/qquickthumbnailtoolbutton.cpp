...
void QQuickThumbnailToolButton::setIconSource(const QUrl &iconSource)
{
    ...
    if (QQuickIconLoader::load(iconSource, qmlEngine(this), QMetaType::QIcon, QSize(),
                               this, &QQuickThumbnailToolButton::iconLoaded) != QQuickIconLoader::LoadResult::Error) {
        m_iconSource = iconSource;
        Q_EMIT iconSourceChanged();
    }
}
 ...
 */
void QQuickThumbnailToolButton::setEnabled(const bool enabled)
{
...
/*!
    ...
    By default, this property is set to true.
 */
void QQuickThumbnailToolButton::setInteractive(const bool interactive)
{
...
/*!
    ...
    By default, this property is set to true.
 */
void QQuickThumbnailToolButton::setVisible(const bool visible)
{
 ...
 */
void QQuickThumbnailToolButton::setDismissOnClick(const bool dismiss)
{
...
/*!
    ...
    By default, this property is set to false.
 */
void QQuickThumbnailToolButton::setFlat(const bool flat)
{
...
{
    if (value.isValid())
        m_button->setIcon(qvariant_cast<QIcon>(value));
}
