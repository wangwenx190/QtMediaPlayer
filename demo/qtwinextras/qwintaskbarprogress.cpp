...
{
    Q_DECLARE_PUBLIC(QWinTaskbarProgress)
    Q_DISABLE_COPY_MOVE(QWinTaskbarProgressPrivate)

public:
    explicit QWinTaskbarProgressPrivate(QWinTaskbarProgress *q)
    {
        Q_ASSERT(q);
        if (q) {
            q_ptr = q;
    ...
    ~QWinTaskbarProgressPrivate() = default;

private:
    QWinTaskbarProgress *q_ptr = nullptr;
...
QWinTaskbarProgress::QWinTaskbarProgress(QObject *parent) :
    QObject(parent), d_ptr(new QWinTaskbarProgressPrivate(this))
{
}
 ...
 */
QWinTaskbarProgress::~QWinTaskbarProgress() = default;
...
void QWinTaskbarProgress::setValue(const int value)
{
...
void QWinTaskbarProgress::setMinimum(const int minimum)
{
    Q_D(QWinTaskbarProgress);
...
void QWinTaskbarProgress::setMaximum(const int maximum)
{
    Q_D(QWinTaskbarProgress);
...
void QWinTaskbarProgress::setVisible(const bool visible)
{
    Q_D(QWinTaskbarProgress);
 ...
 */
void QWinTaskbarProgress::setRange(const int minimum, const int maximum)
{
    Q_D(QWinTaskbarProgress);
...
void QWinTaskbarProgress::setPaused(const bool paused)
{
    Q_D(QWinTaskbarProgress);
