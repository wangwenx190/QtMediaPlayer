...
{
    Q_DISABLE_COPY_MOVE(QWinThumbnailToolButtonPrivate)
    Q_DECLARE_PUBLIC(QWinThumbnailToolButton)

public:
    explicit QWinThumbnailToolButtonPrivate(QWinThumbnailToolButton *q)
    {
        Q_ASSERT(q);
        if (q) {
            q_ptr = q;
    ...
    ~QWinThumbnailToolButtonPrivate() = default;

private:
    QWinThumbnailToolButton *q_ptr = nullptr;
...
QWinThumbnailToolButton::QWinThumbnailToolButton(QObject *parent) :
    QObject(parent), d_ptr(new QWinThumbnailToolButtonPrivate(this))
{
}
...
/*!
    ...
    \sa interactive
 */
void QWinThumbnailToolButton::setEnabled(const bool enabled)
{
    Q_D(QWinThumbnailToolButton);
...
/*!
    ...
    \sa enabled
 */
void QWinThumbnailToolButton::setInteractive(const bool interactive)
{
    Q_D(QWinThumbnailToolButton);
...
/*!
    ...
    The default value is \c true.
 */
void QWinThumbnailToolButton::setVisible(const bool visible)
{
    Q_D(QWinThumbnailToolButton);
 ...
 */
void QWinThumbnailToolButton::setDismissOnClick(const bool dismiss)
{
    Q_D(QWinThumbnailToolButton);
    if (d->dismiss != dismiss) {
        d->dismiss = dismiss;
        Q_EMIT dismissOnClickChanged();
        Q_EMIT changed();
    }
}
 ...
 */
void QWinThumbnailToolButton::setFlat(const bool flat)
{
    Q_D(QWinThumbnailToolButton);
    if (d->flat != flat) {
        d->flat = flat;
